...
# where d1..d4, bt are encoder/bottleneck feature maps in NCHW.
...
class DWUNet(nn.Module):
    ...
    """
    def __init__(self, in_ch: int = 1, base: int = 32, out_ch: int = 1, r: int = 4):
        super().__init__()
        b = base
...
def make_student_dwunet(in_ch: int = 1, out_ch: int = 1, base: int = 32, r: int = 4) -> DWUNet:
